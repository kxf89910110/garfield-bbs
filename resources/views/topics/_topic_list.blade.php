      ...
      <li class="media">
        <div class="media-left">
          <a href="{{ route('users.show', [$topic->user_id]) }}">
            <img class="media-object img-thumbnail mr-3" style="width: 52px; height: 52px;" src="{{ $topic->user->avatar }}" title="{{ $topic->user->name }}"></img>
          </a>
        </div>
        ...
        <div class="media-body">
          ...
          <small class="media-body meta text-secondary">
            ...
            <span class="timeago" title="Finally active in: {{ $topic->updated_at }}">
